...
import {  AuthService, AlertService, UserService,
  ...
  DateDiffService, MissionService, ChatService} from './_services/index';
...
import { InputTextareaModule, EditorModule, SharedModule, AccordionModule,
  CalendarModule, TabViewModule, GrowlModule, MessagesModule, CaptchaModule, PickListModule,
  RadioButtonModule, CheckboxModule, ListboxModule} from 'primeng/primeng';
...
import { FindMissionsPageComponent} from './pages/find-missions-page/find-missions-page.component';
import { FindMissionsContentComponent} from './contents/find-missions-content/find-missions-content.component';
import { MissionCandidatePageComponent } from './pages/mission-candidate-page/mission-candidate-page.component';
import { MissionCandidateContentComponent } from './contents/mission-candidate-content/mission-candidate-content.component';
import { WaitlistTabComponent } from './contents/mission-candidate-content/waitlist-tab/waitlist-tab.component';

import { NoticePageComponent } from './pages/notice-page/notice-page.component';
import { NoticeContentComponent } from './contents/notice-content/notice-content.component';
import { InvitedTabComponent } from './contents/mission-candidate-content/invited-tab/invited-tab.component';

import {PopOutMessageServiceService, } from './_services/index';
import {InvWaitTabService} from './_services/inv-wait-tab.service';
...
@NgModule({
  declarations: [
    ...
    FindMissionsPageComponent,
    FindMissionsContentComponent,
    MissionCandidatePageComponent,
    MissionCandidateContentComponent,
